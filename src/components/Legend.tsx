...
import { Building2, Users, User, Calendar, Clock } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        <h3 className="font-semibold text-gray-800 mb-3">Phân loại Session</h3>
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium text-gray-800">Session Năm</p>
              <p className="text-sm text-gray-600">Mục tiêu dài hạn của tổ chức</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium text-gray-800">Session Quý</p>
              <p className="text-sm text-gray-600">Mục tiêu ngắn hạn theo quý</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Team Selector */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        <h3 className="font-semibold text-gray-800 mb-3">Quy tắc hiển thị</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <div className="flex items-start space-x-2">
            <div className="w-2 h-2 bg-blue-500 rounded-full mt-1.5 flex-shrink-0"></div>
            <span><strong>Leadership Team:</strong> Ưu tiên hiển thị mục tiêu Company</span>
          </div>
          <div className="flex items-start space-x-2">
            <div className="w-2 h-2 bg-green-500 rounded-full mt-1.5 flex-shrink-0"></div>
            <span><strong>Department Team:</strong> Ưu tiên hiển thị mục tiêu Department</span>
          </div>
          <div className="flex items-start space-x-2">
            <div className="w-2 h-2 bg-purple-500 rounded-full mt-1.5 flex-shrink-0"></div>
            <span><strong>View Năm:</strong> Hiển thị cả năm và các quý</span>
          </div>
          <div className="flex items-start space-x-2">
            <div className="w-2 h-2 bg-emerald-500 rounded-full mt-1.5 flex-shrink-0"></div>
            <span><strong>View Quý:</strong> Chỉ hiển thị quý đang active</span>
          </div>
        </div>
      </div>
    </div>
